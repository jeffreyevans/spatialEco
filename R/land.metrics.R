...
#'  
#' @note 
#' It is critical to note that if using polygon units that, the resulting metric represents 
#' the spatial pattern within each unique aggregate unit and not a metric of the unit itself. 
#' That is to say, a metric such as fractal dimension represents the fractal dimension of the 
#' pattern within the unit and not of the unit.   
#'
