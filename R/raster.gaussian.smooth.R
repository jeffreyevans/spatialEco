...
#' @param type      The statistic to use in the smoothing operator (suggest mean or sd)
#' @param sigma     standard deviation (sigma) of kernel (default is 2)
#' @param n         Size of the focal matrix, single value (default is 5 for 5x5 window) 
...
#'  g1 <- raster.gaussian.smooth(r, sigma=1, n=11)
#'  g2 <- raster.gaussian.smooth(r, sigma=2, n=11)
#'  g3 <- raster.gaussian.smooth(r, sigma=3, n=11)
#'  g4 <- raster.gaussian.smooth(r, sigma=4, n=11)
#' 
#' par(mfrow=c(2,2)) 
