...
#'  } 
#'
#' @note This function provides a bivariate moving window correlation using the modified t-test to account for spatial autocorrelation. Point based subsampling is provided for computation tractability.  The hexagon sampleing is recomended as it it good at capturing spatial process that includes nonstationarity and anistropy.    
#' 
