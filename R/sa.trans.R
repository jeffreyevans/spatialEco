...
#' @description The Trigonometric  Stage (1978) [slope * cos(aspect)] or [slope * sin(aspect)] 
#'
...
#' @param slp.units   Units of slope values, options are: "degrees", "radians" or "percent"
#' @param asp.units   Units of aspect values, options are: "degrees" or "radians"
#'
