...
#' @note   srad      Incident shortwave radiation flux density (W/m^2), taken as average over daylight 
#'                     period of the day. 
#' @note   prcp      Daily total precipitation(mm/day), sum of all forms converted to water-equivalent.
#' @note   dayl      Duration of the daylight period for the day (s/day). Calculation is based on the 
#'                     period of the day during which the sun is above a hypothetical flat horizon. 
#'
...
#'                                                                           
#' @references Thornton P.E., S.W. Running and M.A. White (1997) Generating surfaces of daily 
#'               meteorological variables over large regions of complex terrain. Journal of
#'               Hydrology 190: 214-251. 
#' @references Thornton, P.E. and S.W. Running (1999) An improved algorithm for estimating 
...
#' @references Thornton, P.E., H. Hasenauer and M.A. White (2000) Simultaneous estimation 
