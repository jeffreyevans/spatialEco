...
#'   \item {raster layer 4} {lower confidence level at 95 pct, if 
#'                           confidence TRUE}
#'   \item {raster layer 5} {upper confidence level at 95 pct, if 
#'                           confidence TRUE}
#'   \item {raster layer 6} {Kendall's tau two-sided test, reject null at 0, 
#'                           if tau TRUE}
#' }
#'
#' @details 
